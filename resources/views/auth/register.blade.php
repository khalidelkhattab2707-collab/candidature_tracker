...
<div class="flex min-h-screen">
        ...
        <div class="hidden lg:flex w-1/2 relative overflow-hidden"
            ...
            <div class="flex flex-col justify-center px-16 w-full z-10">
                ...
                <div class="flex items-center gap-2 mt-4">
                    <span class="w-8 h-2 rounded-full bg-white/30"></span>
        ...
        <div class="w-full lg:w-1/2 bg-[#f8f8fa] flex items-center justify-center p-6 lg:p-8 min-h-screen">
            ...
            <div class="w-full max-w-[420px]">
                ...
                {{-- Titre --}}
                <h1 class="mt-10 text-3xl font-bold text-gray-900 text-center">C'est parti</h1>
                <p class="mt-2 text-gray-500 text-center text-sm">Créez votre compte pour commencer le suivi.</p>
